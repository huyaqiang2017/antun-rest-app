...
public class PingAnJieKouTest {
	...
	public void test002(){
		...
		builder.append("userBirth=1991-04-08&");
		builder.append("userPhone=18876534566&");
		builder.append("userIdNo=32012519947894561x&");
		...
		String url = "http://47.94.250.65/pinganjiekou/user/add?"
				+ "userName=中户&"
				+ "userSex=0&"
				+ "userBirth=1991-04-08&"
				+ "userPhone=18876534568&"
				+ "userIdNo=32012519947894561x&"
				+ "province=110000&"
				+ "city=110100&"
				+ "town=110101&"
				+ "channelCode=afangti_huhuabo_001&"
				+ "channelToken=-67-75-49-31-96-89-29-1191749116-528-4926-43&"
				+ "productCode=PA000000CXSF-CXWY-01";
		PingAnJieKouResponse forObject = restTemplate.getForObject(url, PingAnJieKouResponse.class);
